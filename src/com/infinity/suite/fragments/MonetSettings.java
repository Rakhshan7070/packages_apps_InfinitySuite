...
import com.infinity.support.preferences.SecureSettingSeekBarPreference;
...
public class MonetSettings extends SettingsPreferenceFragment implements
    ...
    private void updatePreferences() {
        ...
        if (overlayPackageJson != null && !overlayPackageJson.isEmpty()) {
	        ...
	        mLuminancePref.setValue(luminV + 100);
	        mLuminancePref.setSummary("Current value: " + luminV);
                int chromaV = 0;
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (preference == mThemeStylePref) {
            ...
            int mappedValue = value - 100;
            setLuminanceValue(mappedValue);
            return true;
    ...
    private void setLuminanceValue(int lumin) {
        try {
            ...
            if (lumin == 0) {
                ...
                double luminValue = 1d + ((double) lumin / 100d);
                object.putOpt(OVERLAY_LUMINANCE_FACTOR, luminValue);
            }
            putSettingsJson(object);
        } catch (JSONException | IllegalArgumentException ignored) {}
    }
