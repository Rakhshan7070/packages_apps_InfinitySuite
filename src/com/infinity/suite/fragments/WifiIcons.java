    ...
    private void updatePreview(RecyclerView recyclerView) {
        ...
        if (centerView != null) {
            ...
            if (centerPosition >= 0 && centerPosition < mPkgs.size()) {
                ...
                previewImage1.setImageDrawable(getDrawable(getActivity(), pkg, "ic_wifi_signal_0"));
                previewImage2.setImageDrawable(getDrawable(getActivity(), pkg, "ic_wifi_signal_2"));
                previewImage3.setImageDrawable(getDrawable(getActivity(), pkg, "ic_wifi_signal_3"));
                previewImage4.setImageDrawable(getDrawable(getActivity(), pkg, "ic_wifi_signal_4"));
                mSelectedPkg = pkg;
