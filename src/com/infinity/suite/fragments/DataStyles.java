...
public class DataStyles extends SettingsPreferenceFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.data_icon_view_horizontal, container, false);
    ...
    private void updatePreview(RecyclerView recyclerView) {
        ...
        if (centerView != null) {
            ...
            if (centerPosition >= 0 && centerPosition < mPkgs.size()) {
                ...
                previewImage1.setImageDrawable(getDrawable(getActivity(), pkg, "ic_4g_mobiledata"));
                previewImage2.setImageDrawable(getDrawable(getActivity(), pkg, "ic_lte_mobiledata"));
                previewImage3.setImageDrawable(getDrawable(getActivity(), pkg, "ic_5g_mobiledata"));
                mSelectedPkg = pkg;
