    ...
    private void updatePreview(RecyclerView recyclerView) {
        ...
        if (centerView != null) {
            ...
            if (centerPosition >= 0 && centerPosition < mPkgs.size()) {
                ...
                previewImage1.setImageDrawable(getDrawable(getActivity(), pkg, "ic_qs_dnd"));
                previewImage2.setImageDrawable(getDrawable(getActivity(), pkg, "ic_qs_bluetooth"));
                previewImage3.setImageDrawable(getDrawable(getActivity(), pkg, "ic_qs_airplane"));
                previewImage4.setImageDrawable(getDrawable(getActivity(), pkg, "ic_qs_flashlight"));
                mSelectedPkg = pkg;
