...
public class QsHeaderImageSettings extends SettingsPreferenceFragment implements
    ...
    public void onCreate(Bundle icicle) {
        ...
        String customImageUri = null;
        if (icicle != null) {
            customImageUri = icicle.getString("custom_image_uri");
            android.util.Log.d("QsHeaderImageSettings", "Restored custom image URI from bundle: " + customImageUri);
        }
        if (customImageUri == null) {
            customImageUri = Settings.System.getString(resolver, Settings.System.STATUS_BAR_FILE_HEADER_IMAGE);
            android.util.Log.d("QsHeaderImageSettings", "Loaded custom image URI from settings: " + customImageUri);
        }
        ...
        if (customImageUri != null) {
            mFileHeader.setSummary(customImageUri);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String customImageUri = Settings.System.getString(getActivity().getContentResolver(), Settings.System.STATUS_BAR_FILE_HEADER_IMAGE);
        if (customImageUri != null) {
            outState.putString("custom_image_uri", customImageUri);
            android.util.Log.d("QsHeaderImageSettings", "Saved custom image URI: " + customImageUri);
        }
    }
    ...
    public void onResume() {
        super.onResume();
        ContentResolver resolver = getActivity().getContentResolver();
        String customImageUri = Settings.System.getString(resolver, Settings.System.STATUS_BAR_FILE_HEADER_IMAGE);
        if (customImageUri != null) {
            mFileHeader.setSummary(customImageUri);
            android.util.Log.d("QsHeaderImageSettings", "Custom image URI onResume: " + customImageUri);
        }
    }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent result) {
        if (requestCode == REQUEST_PICK_IMAGE) {
            ...
            if (imageUri != null) {
                ...
                mFileHeader.setSummary(imageUri.toString());
                android.util.Log.d("QsHeaderImageSettings", "Custom image URI set: " + imageUri.toString());
            }
        }
    }
