...
public class Spoof extends SettingsPreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mUpdateJsonButton.setOnPreferenceClickListener(preference -> {
            updatePropertiesFromUrl("https://raw.githubusercontent.com/ProjectInfinity-X/vendor_extras/refs/heads/15/pif/pif.json");
            return true;
        });
    ...
    private void showAppSelectionDialog() {
        new Thread(() -> {
            ...
            mHandler.post(() -> {
                ...
                builder.setPositiveButton(R.string.save, (dialog, which) -> InfinityUtils.showSystemRestartDialog(getContext()));
